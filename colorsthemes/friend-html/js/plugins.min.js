...
[Table of Contents]
1. Modernizr 2.6.2
2. Sticky Plugin v1.0.4
3. Nivo Lightbox v1.3.1 - migrated(.error, .loadx2)
4. object-fit-images v3.2.4
	# jarallax.min.js 2.1.3
6. Waypoints v4.0.1
	Fixed 1(isFunction) migrate issue and Compress at https://jscompress.com/
*/

/* ----------------------------------------------------------------------
	# Bootstrap 5 - Tooltip & Popover
---------------------------------------------------------------------- */
const tooltipTriggerList=document.querySelectorAll('[data-bs-toggle="tooltip"]'),tooltipList=[...tooltipTriggerList].map(o=>new bootstrap.Tooltip(o)),popoverTriggerList=document.querySelectorAll('[data-bs-toggle="popover"]'),popoverList=[...popoverTriggerList].map(o=>new bootstrap.Popover(o));
/* ----------------------------------------------------------------------
	# Modernizr (Not need to update)
---------------------------------------------------------------------- */
/* For hover-dir, iconbox-hover, image-hover-wrap */
...
/* ----------------------------------------------------------------------
	# Sticky Plugin
    # Migrate('s.zIndex')
	# Minify By https://jscompress.com/
---------------------------------------------------------------------- */
 ...
 */
!function(g,v,t){var i="nivoLightbox",e={effect:"fade",theme:"default",keyboardNav:!0,clickImgToClose:!1,clickOverlayToClose:!0,onInit:function(){},beforeShowLightbox:function(){},afterShowLightbox:function(t){},beforeHideLightbox:function(){},afterHideLightbox:function(){},beforePrev:function(t){},onPrev:function(t){},beforeNext:function(t){},onNext:function(t){},errorMessage:"The requested content cannot be loaded. Please try again later."};function o(t,o){this.el=t,this.$el=g(this.el),this.options=g.extend({},e,o),this._defaults=e,this._name=i,this.init()}o.prototype={init:function(){var o=this;g("html").hasClass("nivo-lightbox-notouch")||g("html").addClass("nivo-lightbox-notouch"),"ontouchstart"in t&&g("html").removeClass("nivo-lightbox-notouch"),this.$el.on("click",function(t){o.showLightbox(t)}),this.options.keyboardNav&&g("body").off("keyup").on("keyup",function(t){t=t.keyCode||t.which;27==t&&o.destructLightbox(),37==t&&g(".nivo-lightbox-prev").trigger("click"),39==t&&g(".nivo-lightbox-next").trigger("click")}),this.options.onInit.call(this)},showLightbox:function(t){var o,i,e,n=this,l=this.$el;this.checkContent(l)&&(t.preventDefault(),this.options.beforeShowLightbox.call(this),!(o=this.constructLightbox())||(i=o.find(".nivo-lightbox-content"))&&(g("body").addClass("nivo-lightbox-body-effect-"+this.options.effect),this.processContent(i,l),this.$el.attr("data-lightbox-gallery")&&(e=g('[data-lightbox-gallery="'+this.$el.attr("data-lightbox-gallery")+'"]'),g(".nivo-lightbox-nav").show(),g(".nivo-lightbox-prev").off("click").on("click",function(t){t.preventDefault();t=e.index(l);l=e.eq(t-1),g(l).length||(l=e.last()),g.when(n.options.beforePrev.call(this,[l])).done(function(){n.processContent(i,l),n.options.onPrev.call(this,[l])})}),g(".nivo-lightbox-next").off("click").on("click",function(t){t.preventDefault();t=e.index(l);l=e.eq(t+1),g(l).length||(l=e.first()),g.when(n.options.beforeNext.call(this,[l])).done(function(){n.processContent(i,l),n.options.onNext.call(this,[l])})})),setTimeout(function(){o.addClass("nivo-lightbox-open"),n.options.afterShowLightbox.call(this,[o])},1)))},checkContent:function(t){var o=t.attr("href"),i=o.match(/(youtube|youtube-nocookie|youtu|vimeo)\.(com|be)\/(watch\?v=([\w-]+)|([\w-]+))/);return null!==o.match(/\.(jpeg|jpg|gif|png)$/i)||(!!i||("ajax"==t.attr("data-lightbox-type")||("#"==o.substring(0,1)&&"inline"==t.attr("data-lightbox-type")||"iframe"==t.attr("data-lightbox-type"))))},processContent:function(i,t){var o,e=this,n=t.attr("href"),l=n.match(/(youtube|youtube-nocookie|youtu|vimeo)\.(com|be)\/(watch\?v=([\w-]+)|([\w-]+))/);if(i.html("").addClass("nivo-lightbox-loading"),this.isHidpi()&&t.attr("data-lightbox-hidpi")&&(n=t.attr("data-lightbox-hidpi")),null!==n.match(/\.(jpeg|jpg|gif|png)$/i)){var a=g("<img>",{src:n,class:"nivo-lightbox-image-display"});a.one("load",function(){var t=g('<div class="nivo-lightbox-image" />');t.append(a),i.html(t).removeClass("nivo-lightbox-loading"),t.css({"line-height":g(".nivo-lightbox-content").height()+"px",height:g(".nivo-lightbox-content").height()+"px"}),g(v).resize(function(){t.css({"line-height":g(".nivo-lightbox-content").height()+"px",height:g(".nivo-lightbox-content").height()+"px"})})}).each(function(){this.complete&&g(this).on("load")}),a.on("error",function(){var t=g('<div class="nivo-lightbox-error"><p>'+e.options.errorMessage+"</p></div>");i.html(t).removeClass("nivo-lightbox-loading")})}else if(l){var h,s="",r="nivo-lightbox-video";"youtube"==l[1]&&(s="//www.youtube.com/embed/"+l[4],r="nivo-lightbox-youtube"),"youtube-nocookie"==l[1]&&(s=n,r="nivo-lightbox-youtube"),"youtu"==l[1]&&(s="//www.youtube.com/embed/"+l[3],r="nivo-lightbox-youtube"),"vimeo"==l[1]&&(s="//player.vimeo.com/video/"+l[3],r="nivo-lightbox-vimeo"),s&&(h=g("<iframe>",{src:s,class:r,frameborder:0,vspace:0,hspace:0,scrolling:"auto"}),i.html(h),h.on("load",function(){i.removeClass("nivo-lightbox-loading")}))}else if("ajax"==t.attr("data-lightbox-type"))g.ajax({url:n,cache:!1,success:function(t){var o=g('<div class="nivo-lightbox-ajax" />');o.append(t),i.html(o).removeClass("nivo-lightbox-loading"),o.outerHeight()<i.height()&&o.css({position:"relative",top:"50%","margin-top":-o.outerHeight()/2+"px"}),g(v).resize(function(){o.outerHeight()<i.height()&&o.css({position:"relative",top:"50%","margin-top":-o.outerHeight()/2+"px"})})},error:function(){var t=g('<div class="nivo-lightbox-error"><p>'+e.options.errorMessage+"</p></div>");i.html(t).removeClass("nivo-lightbox-loading")}});else if("#"==n.substring(0,1)&&"inline"==t.attr("data-lightbox-type"))g(n).length?((o=g('<div class="nivo-lightbox-inline" />')).append(g(n).clone().show()),i.html(o).removeClass("nivo-lightbox-loading"),o.outerHeight()<i.height()&&o.css({position:"relative",top:"50%","margin-top":-o.outerHeight()/2+"px"}),g(v).resize(function(){o.outerHeight()<i.height()&&o.css({position:"relative",top:"50%","margin-top":-o.outerHeight()/2+"px"})})):(h=g('<div class="nivo-lightbox-error"><p>'+e.options.errorMessage+"</p></div>"),i.html(h).removeClass("nivo-lightbox-loading"));else{if("iframe"!=t.attr("data-lightbox-type"))return!1;var c=g("<iframe>",{src:n,class:"nivo-lightbox-item",frameborder:0,vspace:0,hspace:0,scrolling:"auto"});i.html(c),c.load(function(){i.removeClass("nivo-lightbox-loading")})}t.attr("title")?((c=g("<span>",{class:"nivo-lightbox-title"})).text(t.attr("title")),g(".nivo-lightbox-title-wrap").html(c)):g(".nivo-lightbox-title-wrap").html("")},constructLightbox:function(){if(g(".nivo-lightbox-overlay").length)return g(".nivo-lightbox-overlay");var t=g("<div>",{class:"nivo-lightbox-overlay nivo-lightbox-theme-"+this.options.theme+" nivo-lightbox-effect-"+this.options.effect}),o=g("<div>",{class:"nivo-lightbox-wrap"}),i=g("<div>",{class:"nivo-lightbox-content"}),e=g('<a href="#" class="nivo-lightbox-nav nivo-lightbox-prev">Previous</a><a href="#" class="nivo-lightbox-nav nivo-lightbox-next">Next</a>'),n=g('<a href="#" class="nivo-lightbox-close" title="Close">Close</a>'),l=g("<div>",{class:"nivo-lightbox-title-wrap"});o.append(i),o.append(l),t.append(o),t.append(e),t.append(n),g("body").append(t);var a=this;return a.options.clickOverlayToClose&&t.on("click",function(t){(t.target===this||g(t.target).hasClass("nivo-lightbox-content")||g(t.target).hasClass("nivo-lightbox-image"))&&a.destructLightbox()}),a.options.clickImgToClose&&t.on("click",function(t){t.target!==this&&!g(t.target).hasClass("nivo-lightbox-image-display")||a.destructLightbox()}),n.on("click",function(t){t.preventDefault(),a.destructLightbox()}),t},destructLightbox:function(){this.options.beforeHideLightbox.call(this),g(".nivo-lightbox-overlay").removeClass("nivo-lightbox-open"),g(".nivo-lightbox-nav").hide(),g("body").removeClass("nivo-lightbox-body-effect-"+this.options.effect);g(".nivo-lightbox-prev").off("click"),g(".nivo-lightbox-next").off("click"),g(".nivo-lightbox-content").empty(),this.options.afterHideLightbox.call(this)},isHidpi:function(){return 1<v.devicePixelRatio||!(!v.matchMedia||!v.matchMedia("(-webkit-min-device-pixel-ratio: 1.5),                              (min--moz-device-pixel-ratio: 1.5),                              (-o-min-device-pixel-ratio: 3/2),                              (min-resolution: 1.5dppx)").matches)}},g.fn[i]=function(t){return this.each(function(){g.data(this,i)||g.data(this,i,new o(this,t))})}}(jQuery,window,document);/* ----------------------------------------------------------------------
	# Object Fit Images
---------------------------------------------------------------------- */
